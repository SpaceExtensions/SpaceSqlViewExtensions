  define("ChangeDataUserTaskPropertiesPage", ["ServiceHelper"], function(ServiceHelper) {
	const serviceName = "SpaceConvertFilterDataToEsqService";
	const getQueryMethodName = "GetQueryEditDataUserTask";
	const getQueryPlanMethodName = "GetQueryPlanEditDataUserTask";
